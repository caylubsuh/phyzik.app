...
export const PLAY_STORE_URL =
  'https://play.google.com/store/apps/details?id=com.physiquetech.phyzik'
export const BUNDLE_ID = 'com.physiquetech.physiqueai'
export const ANDROID_PACKAGE = 'com.physiquetech.phyzik'
...
export const BRAND = {
  ...
  tagline: 'The social training platform for lifters.',
  description:
    'Every set, every PR, every meal — logged, analyzed, and built into one training system for serious lifters.',
} as const
