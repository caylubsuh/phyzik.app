...
export const FEATURES: FeatureData[] = [
  ...
  },
  {
    id: 'nutrition',
    pill: 'NUTRITION',
    body: 'Every meal, every macro — against a plan that adapts to your training. Calories shift between training and rest days automatically. Search 300,000+ USDA-backed foods, log through the day, and save your go-tos.',
    image: '/screenshots/marketing/08-nutrition.png',
    imageAlt: 'PHYZIK nutrition tracking with calories, macros, and a daily meal log',
    imagePosition: 'right',
    accent: true,
  },
  {
  ...
  },
  {
    id: 'performance',
    pill: 'PERFORMANCE',
    body: 'Your whole training story in one place. Streaks, PRs, workouts completed, and badges — plus a Performance Index that scores every week on consistency, overload, volume, and intensity.',
    image: '/screenshots/marketing/09-you.png',
    imageAlt: 'PHYZIK profile and Performance Index with streaks, PRs, and badges',
    imagePosition: 'left',
    accent: true,
  },
]
