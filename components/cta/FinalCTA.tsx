  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 50% at 50% 50%, rgba(168,137,46,0.16) 0%, transparent 65%), linear-gradient(180deg, #0A0A0B 0%, #050506 100%)',
        }}
      />
      <div
        aria-hidden="true"
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 55% at 50% 50%, rgba(168,137,46,0.22) 0%, rgba(168,137,46,0.05) 38%, transparent 70%)',
        }}
      />
      <div
        aria-hidden="true"
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent 0%, rgba(168,137,46,0.3) 50%, transparent 100%)',
        }}
      />
      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center gap-8 text-center md:gap-10">
          ...
          <FadeUp delay={0.05}>
            <h2 className="text-balance font-display text-[clamp(3rem,8vw,7rem)] font-extrabold leading-[0.95] tracking-tightest text-text-primary">
              Start <span className="text-shimmer-gold">tonight.</span>
            </h2>
          </FadeUp>
