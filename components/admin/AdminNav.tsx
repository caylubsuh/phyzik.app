...
/**
 * Admin console navigation. Vertical sidebar on lg+, horizontal scroll-rail on
 * small screens. Mirrors MerchantNav's treatment (gold left-bar when active).
 */
export default function AdminNav() {
  ...
  const items = [
    ...
    { label: 'Applications', href: '/admin/applications', icon: Inbox, exact: false },
    { label: 'Brands', href: '/admin/brands', icon: Store, exact: false },
    { label: 'Products', href: '/admin/products', icon: PackageCheck, exact: false },
  ...
  return (
    <nav aria-label="Admin sections" className="lg:sticky lg:top-28">
      ...
      <p className="mb-3 hidden text-[10.5px] font-bold uppercase tracking-[0.2em] text-text-tertiary lg:block">
        Platform admin
      </p>
